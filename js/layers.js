...
if (hasMilestone('m', 4)) {
    ...
    challenges: {
        ...
        12: {
            ...
            onComplete() {},
            unlocked() { return hasChallenge('m',11)|| player.m.activeChallenge == 11 || hasChallenge('m', 11) }
        },
         13: {
            ...
            onComplete() {},
            unlocked() { return hasChallenge('m',12)|| player.m.activeChallenge == 12 || hasChallenge('m', 12) }
        },
    },
});
addLayer("ach", {
